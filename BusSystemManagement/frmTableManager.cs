...
namespace BusSystemManagement
{
    public partial class frmTableManager : Form
    {
        ...
        {
            dgvStat.DataSource = BUS_Ticket.GetTicketStatSearch(Convert.ToDateTime(dtpStartDayStat.Value.Date).ToString("yyyy/MM/dd"), 
                Convert.ToDateTime(dtpEndDayStat.Value.Date).ToString("yyyy/MM/dd"));
        }
