...
namespace DTO_BusSystemManagement
{
	 public class DTO_User
	 {
		  ...
		  public int USER_ID
		  {
				get => _USER_ID; set => _USER_ID = value;
		  }
		  public string USER_USERNAME
		  {
				get => _USER_USERNAME; set => _USER_USERNAME = value;
		  }
		  public string USER_PASSWORD
		  {
				get => _USER_PASSWORD; set => _USER_PASSWORD = value;
		  }
		  public string USER_EMAIL
		  {
				get => _USER_EMAIL; set => _USER_EMAIL = value;
		  }
		  public DateTime USER_CREATEDDATE
		  {
				get => _USER_CREATEDDATE; set => _USER_CREATEDDATE = value;
		  }
	 }
}
